...
> Current session state for Company ProjectOps development
> 
...
| Email | Password | Role |
|-------|----------|------|
| admin@democorp.local | password | admin (Super-Admin) |
| manager@democorp.local | password | manager |
| reviewer@democorp.local | password | reviewer |
| preparer@democorp.local | password | preparer |
